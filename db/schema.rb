...
ActiveRecord::Schema.define(version: 2020_11_05_193505) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "blogpost_categories", force: :cascade do |t|
    t.string "name"
    t.integer "position"
  ...
  create_table "blogposts", force: :cascade do |t|
    ...
    t.text "body"
    t.date "date"
    t.bigint "blogpost_category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.jsonb "keywords", default: []
    t.index ["blogpost_category_id"], name: "index_blogposts_on_blogpost_category_id"
  end
  ...
  add_foreign_key "blogposts", "blogpost_categories"
end
